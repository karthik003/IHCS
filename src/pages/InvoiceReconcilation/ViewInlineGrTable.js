...
const ViewInlineGrTable = (props) => {
  const { data, tableTitle, setisViewPopup } = props;
  ...
  return (
    <div className="view-inline-table">
                    ...
                    {item.sorting &&
                      (sortConfig && sortConfig.dataRef === item.dataRef ? (
                        <ButtonBase className="sort active-sort" onClick={() => requestSort(item.dataRef, index)}>
                          <i
                            className={
                              sortConfig.sortType === "ascending" ? "fas fa-chevron-down" : "fas fa-chevron-up"
                            }
                          ></i>
                        </ButtonBase>
                      ) : (
...
ViewInlineGrTable.propTypes = {
  data: PropTypes.object.isRequired,
  tableTitle: PropTypes.string,
  setisViewPopup: PropTypes.func,
};

export default ViewInlineGrTable;
